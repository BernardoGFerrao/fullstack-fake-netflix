...
if DATABASE_URL:
    DATABASES = {
        'default': dj_database_url.config(default='postgresql://postgres:vmfOLXGqEAAzyYcGJhAxAbOgtpHpnNwn@viaduct.proxy.rlwy.net:38227/railway', conn_max_age=1800),
        }


# Password validation
# https://docs.djangoproject.com/en/5.0/ref/settings/#auth-password-validators
AUTH_USER_MODEL = "filme.Usuario" #App filme Classe usuário
...
STATIC_URL = '/static/' #Static -> Imagens que o administrador usa
#Medias -> Imagens que os usuários enviam
